; ======================================================================
; Calculadora Simples em Assembly (NASM) para Linux 32-bit
; Descrição: Lê dois números e uma operação, depois exibe o resultado.
; Esta versão inclui tratamento correto para números negativos e divisão.
; ======================================================================
...
; ======================================================================
; ROTINAS DE CONVERSÃO CORRIGIDAS
; ======================================================================
